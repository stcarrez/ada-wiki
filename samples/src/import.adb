...
--  Copyright (C) 2015, 2016, 2020, 2021, 2022, 2025 Stephane Carrez
...
procedure Import is
   ...
   begin
      ...
      Ada.Text_IO.Put_Line ("Usage: import [-t] [-m] [-M] [-H] [-T] [-d] [-c] {URL | file}");
      ...
      Ada.Text_IO.Put_Line ("  -T      Convert to Textile");
...
begin
   loop
      case Getopt ("m M H T d c t f:") is
         when 'm' =>
