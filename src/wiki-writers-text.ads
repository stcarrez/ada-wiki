-----------------------------------------------------------------------
--  wiki-writers-text -- Wiki Text writer
...
package Wiki.Writers.Text is
   ...
   --  Wiki to Text writer
   --  ------------------------------
   type Text_Writer is new Wiki.Documents.Document_Reader with private;

   --  Set the output writer.
   procedure Set_Writer (Document : in out Text_Writer;
                         Writer   : in Writer_Type_Access);
...
private
   ...
   type Text_Writer is new Wiki.Documents.Document_Reader with record
      Writer         : Writer_Type_Access := null;
