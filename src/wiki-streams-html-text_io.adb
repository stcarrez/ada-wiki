...
package body Wiki.Streams.Html.Text_IO is

   --  Close the current XML entity if an entity was started
   procedure Close_Current (Stream : in out Html_File_Output_Stream'Class);

   --  ------------------------------
   --  Close the current XML entity if an entity was started
   --  ------------------------------
   procedure Close_Current (Stream : in out Html_File_Output_Stream'Class) is
   begin
